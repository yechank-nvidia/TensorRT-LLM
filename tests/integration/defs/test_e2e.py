    ...
    expected_answers = {
        ...
        "qwen2-5-vl-7b-instruct": {
            ...
            [[
             ...
             [
                 "The image features a large, prominent rock formation, likely Half Dome, which is a famous landmark in Yosemite National Park, California. The rock formation is surrounded by a clear blue sky with a few scattered clouds, indicating a sunny and pleasant day. The road in the foreground curves gently, and there are trees on both sides",
                 ...
                 "The image features a large, prominent rock formation, which appears to be Half Dome, a famous landmark in Yosemite National Park, California. The rock formation is a granite dome, characterized by its smooth, rounded top and steep sides. The surrounding landscape includes a paved road that curves around the base of the formation, and there",
